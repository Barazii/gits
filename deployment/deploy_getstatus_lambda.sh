...
# Update function code for getstatus lambda.
# Usage:
#   ./deployment/deploy_getstatus_lambda.sh [--publish]
...
SRC_DIR="$ROOT_DIR/getstatus_lambda"
HANDLER_FILE="$SRC_DIR/lambda_function.py"
BUILD_DIR="$ROOT_DIR/.dist"
ZIP_FILE="$BUILD_DIR/getstatus_lambda_code.zip"
