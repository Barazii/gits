...
# Update function code for delete lambda.
# Usage:
#   ./deployment/deploy_delete_lambda.sh [--publish]
...
SRC_DIR="$ROOT_DIR/delete_lambda"
HANDLER_FILE="$SRC_DIR/lambda_function.py"
BUILD_DIR="$ROOT_DIR/.dist"
ZIP_FILE="$BUILD_DIR/delete_lambda_code.zip"
