...
make delete cmd deschedule. fix the names of components/modules mess. change from gits to commitcushion. remove useless comments. make the code look not ai generated.
